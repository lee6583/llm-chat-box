...
**详细的项目从0到1构建过程，包含每一步的技术实现和原理说明**

👉 [查看完整构建说明文档](./项目构建说明.md)
...
1. 直接开始对话（默认无需配置 API Key）
2. 如需使用自己的账户，可在设置中输入 API Key
3. 选择合适的模型（也可直接输入自定义模型 ID）
4. 开始新对话或从历史记录中选择
5. 可以发送文本消息、上传图片或文件
6. 使用 Markdown 语法获得更好的排版效果
